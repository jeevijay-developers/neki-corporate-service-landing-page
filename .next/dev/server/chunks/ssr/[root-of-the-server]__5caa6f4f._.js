...
;
const metadata = {
    title: "Neki Corporate Service LLP - Empowering Growth Through Integrated Business Solutions",
    description: "Professional training, financial advisory, real estate services, and women entrepreneurship platform. Empowering businesses and individuals across India.",
    icons: {
        icon: [
            {
